...
public interface EmployeeRepository extends JpaRepository<Employee, Long> {
    ...
    @Query("select employee from Employee employee left join fetch employee.supervisor where employee.pin =:pin")
    Optional<Employee> findOneWithToOneRelationshipsWithPin(@Param("pin") String pin);
}
