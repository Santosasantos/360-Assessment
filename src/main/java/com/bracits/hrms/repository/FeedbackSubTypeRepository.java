...
import com.bracits.hrms.domain.FeedbackSubType;
...
public interface FeedbackSubTypeRepository extends JpaRepository<FeedbackSubType, Long> {
    ...
    @Query(
        value = "select feedbackSubType from FeedbackSubType feedbackSubType left join fetch feedbackSubType.feedbacktypes",
    ...
    @Query("select feedbackSubType from FeedbackSubType feedbackSubType left join fetch feedbackSubType.feedbacktypes")
    List<FeedbackSubType> findAllWithToOneRelationships();

    @Query(
        "select feedbackSubType from FeedbackSubType feedbackSubType left join fetch feedbackSubType.feedbacktypes where feedbackSubType.id =:id"
    )
