...
import com.bracits.hrms.domain.SkillDevelopmentDetails;
...
public interface SkillDevelopmentDetailsRepository extends JpaRepository<SkillDevelopmentDetails, Long> {
    ...
    @Query(
        value = "select skillDevelopmentDetails from SkillDevelopmentDetails skillDevelopmentDetails left join fetch skillDevelopmentDetails.skilldevelopmenttypes",
    ...
    @Query(
        "select skillDevelopmentDetails from SkillDevelopmentDetails skillDevelopmentDetails left join fetch skillDevelopmentDetails.skilldevelopmenttypes"
    )
    List<SkillDevelopmentDetails> findAllWithToOneRelationships();

    @Query(
        "select skillDevelopmentDetails from SkillDevelopmentDetails skillDevelopmentDetails left join fetch skillDevelopmentDetails.skilldevelopmenttypes where skillDevelopmentDetails.id =:id"
    )
