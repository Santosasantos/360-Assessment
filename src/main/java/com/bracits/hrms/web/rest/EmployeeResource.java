...
/**
 * REST controller for managing {@link com.bracits.hrms.domain.Employee}.
 */
@RestController
...
public class EmployeeResource {
    ...
    public ResponseEntity<Employee> getEmployeeByPin(@PathVariable("pin") String pin) {
        log.debug("REST request to get Employee : {}", pin);
        Optional<Employee> employee = employeeService.findOneWithPin(pin);
        return ResponseUtil.wrapOrNotFound(employee);
    }
