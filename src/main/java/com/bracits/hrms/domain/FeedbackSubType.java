...
public class FeedbackSubType implements Serializable {
    ...
    public void setFeedbacktypes(FeedbackType feedbackType) {
        this.feedbacktypes = feedbackType;
    }

    public FeedbackSubType feedbacktypes(FeedbackType feedbackType) {
        this.setFeedbacktypes(feedbackType);
        return this;
    }
