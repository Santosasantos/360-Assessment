...
import com.bracits.hrms.domain.enumeration.RecommendationValue;
...
public class TeachOther implements Serializable {
    ...
    public Feedback getTeachother() {
        return this.teachother;
    }

    public void setTeachother(Feedback feedback) {
        this.teachother = feedback;
    }

    public TeachOther teachother(Feedback feedback) {
        this.setTeachother(feedback);
        return this;
    }
