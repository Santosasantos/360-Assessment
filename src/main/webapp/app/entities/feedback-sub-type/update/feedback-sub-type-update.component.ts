    ...
    this.feedbackTypeService
      ...
      .pipe(
        map((feedbackTypes: IFeedbackType[]) =>
          this.feedbackTypeService.addFeedbackTypeToCollectionIfMissing<IFeedbackType>(feedbackTypes, this.feedbackSubType?.feedbacktypes),
        ),
      )
