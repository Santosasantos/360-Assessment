...
export class RatingService {
  ...
  findbyratingvalue(ratingvalue: number): Observable<EntityResponseType> {
    return this.http.get<IRating>(`${this.resourceUrl}/getrating/${ratingvalue}`, { observe: 'response' });
  }
