...
public class SkillDevelopmentDetailsAsserts {
    ...
    public static void assertSkillDevelopmentDetailsUpdatableRelationshipsEquals(
        ...
        assertThat(expected)
            ...
            .satisfies(e -> assertThat(e.getSkilldevelopment()).as("check skilldevelopment").isEqualTo(actual.getSkilldevelopment()))
            .satisfies(
                e -> assertThat(e.getSkilldevelopmenttypes()).as("check skilldevelopmenttypes").isEqualTo(actual.getSkilldevelopmenttypes())
            );
    }
}
