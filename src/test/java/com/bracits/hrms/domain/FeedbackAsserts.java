...
public class FeedbackAsserts {
    ...
    public static void assertFeedbackUpdatableRelationshipsEquals(Feedback expected, Feedback actual) {
        assertThat(expected)
            ...
            .satisfies(e -> assertThat(e.getRequesters()).as("check requesters").isEqualTo(actual.getRequesters()))
            .satisfies(e -> assertThat(e.getResponders()).as("check responders").isEqualTo(actual.getResponders()))
