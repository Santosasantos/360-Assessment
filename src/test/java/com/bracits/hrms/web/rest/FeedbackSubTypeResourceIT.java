...
import static com.bracits.hrms.domain.FeedbackSubTypeAsserts.*;
...
import com.bracits.hrms.repository.FeedbackSubTypeRepository;
import com.bracits.hrms.service.FeedbackSubTypeService;
...
class FeedbackSubTypeResourceIT {
    ...
    void partialUpdateFeedbackSubTypeWithPatch() throws Exception {
        ...
        partialUpdatedFeedbackSubType.feedbackdescription(UPDATED_FEEDBACKDESCRIPTION);
