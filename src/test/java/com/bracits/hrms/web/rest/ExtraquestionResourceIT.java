...
import static com.bracits.hrms.domain.ExtraquestionAsserts.*;
...
class ExtraquestionResourceIT {
    ...
    private static final String DEFAULT_QUESTIONFEEDBACK = "AAAAAAAAAA";
    private static final String UPDATED_QUESTIONFEEDBACK = "BBBBBBBBBB";
    ...
    public static Extraquestion createEntity(EntityManager em) {
        Extraquestion extraquestion = new Extraquestion().question(DEFAULT_QUESTION).questionfeedback(DEFAULT_QUESTIONFEEDBACK);
    ...
    public static Extraquestion createUpdatedEntity(EntityManager em) {
        Extraquestion extraquestion = new Extraquestion().question(UPDATED_QUESTION).questionfeedback(UPDATED_QUESTIONFEEDBACK);
        return extraquestion;
    }
    ...
    void getAllExtraquestions() throws Exception {
        ...
        restExtraquestionMockMvc
            ...
            .andExpect(jsonPath("$.[*].questionfeedback").value(hasItem(DEFAULT_QUESTIONFEEDBACK)));
    }
    ...
    void getExtraquestion() throws Exception {
        ...
        restExtraquestionMockMvc
            ...
            .andExpect(jsonPath("$.questionfeedback").value(DEFAULT_QUESTIONFEEDBACK));
    }
    ...
    void putExistingExtraquestion() throws Exception {
        ...
        updatedExtraquestion.question(UPDATED_QUESTION).questionfeedback(UPDATED_QUESTIONFEEDBACK);
    ...
    void partialUpdateExtraquestionWithPatch() throws Exception {
        ...
        partialUpdatedExtraquestion.questionfeedback(UPDATED_QUESTIONFEEDBACK);
    ...
    void fullUpdateExtraquestionWithPatch() throws Exception {
        ...
        partialUpdatedExtraquestion.question(UPDATED_QUESTION).questionfeedback(UPDATED_QUESTIONFEEDBACK);
