...
import static com.bracits.hrms.domain.FeedbackDetailsAsserts.*;
...
class FeedbackDetailsResourceIT {
    ...
    public static FeedbackDetails createEntity(EntityManager em) {
        FeedbackDetails feedbackDetails = new FeedbackDetails().commentsforfeedbacksubtype(DEFAULT_COMMENTSFORFEEDBACKSUBTYPE);
    ...
    public static FeedbackDetails createUpdatedEntity(EntityManager em) {
        FeedbackDetails feedbackDetails = new FeedbackDetails().commentsforfeedbacksubtype(UPDATED_COMMENTSFORFEEDBACKSUBTYPE);
        return feedbackDetails;
    }
    ...
    void putExistingFeedbackDetails() throws Exception {
        ...
        updatedFeedbackDetails.commentsforfeedbacksubtype(UPDATED_COMMENTSFORFEEDBACKSUBTYPE);
