...
import static com.bracits.hrms.domain.FeedbackAsserts.*;
...
class FeedbackResourceIT {
    ...
    public static Feedback createEntity(EntityManager em) {
        Feedback feedback = new Feedback().requestDate(DEFAULT_REQUEST_DATE).status(DEFAULT_STATUS).responseDate(DEFAULT_RESPONSE_DATE);
        return feedback;
    }
    ...
    public static Feedback createUpdatedEntity(EntityManager em) {
        Feedback feedback = new Feedback().requestDate(UPDATED_REQUEST_DATE).status(UPDATED_STATUS).responseDate(UPDATED_RESPONSE_DATE);
        return feedback;
    }
    ...
    void putExistingFeedback() throws Exception {
        ...
        updatedFeedback.requestDate(UPDATED_REQUEST_DATE).status(UPDATED_STATUS).responseDate(UPDATED_RESPONSE_DATE);
    ...
    void partialUpdateFeedbackWithPatch() throws Exception {
        ...
        partialUpdatedFeedback.requestDate(UPDATED_REQUEST_DATE).responseDate(UPDATED_RESPONSE_DATE);
    ...
    void fullUpdateFeedbackWithPatch() throws Exception {
        ...
        partialUpdatedFeedback.requestDate(UPDATED_REQUEST_DATE).status(UPDATED_STATUS).responseDate(UPDATED_RESPONSE_DATE);
