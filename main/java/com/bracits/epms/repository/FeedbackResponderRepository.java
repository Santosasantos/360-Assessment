...
public interface FeedbackResponderRepository extends JpaRepository<FeedbackResponder, Long> {
    ...
    @Query("select feedbackResponder from FeedbackResponder feedbackResponder left join fetch feedbackResponder.feedback and left join fetch feedbackResponder.employee where feedbackResponder.feedback.id =:id")
