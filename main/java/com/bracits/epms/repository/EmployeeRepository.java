...
public interface EmployeeRepository extends JpaRepository<Employee, Long> {
    ...
    @Query("SELECT e FROM Employee e WHERE e.id != :employeeId AND ((e.grade BETWEEN :grade - 1 AND :grade + 1 AND e.grade != :grade) OR e.functionalDesignation = :functionaldesignation)")
