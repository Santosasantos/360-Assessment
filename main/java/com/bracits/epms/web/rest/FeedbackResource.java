...
public class FeedbackResource {
    ...
    public ResponseEntity<List<Employee>> getEligibleEmployees(@RequestParam ResponderCategory category, @RequestParam String currentUserPin) {
    ...
    public ResponseEntity<List<Employee>> searchEmployees(@RequestParam String term, @RequestParam ResponderCategory category, @RequestParam String currentUserPin) {
